...
def all_odd(numbers):
    ...
    For example::
        ...
        []
    """
    all_odd = [num for num in numbers if num%2==1]
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    #================ my terminal is printing set(['bagel', 'kale']) insted of ['bagel', 'kale'], I couldnt
    #================ figure out why it was doing this 
...
def largest_n_items(items, n):
    ...
    n = items[-n:]
    return n
    # =====================printing [[3,3]] instead of [3,3] not quite sure why its doing that************
